    ...
    upload.fields([{ name: "images", maxCount: 10 }])(
      ...
      async (err) => {
        ...
        try {
          ...
          const ALLOWED_REDIRECT_SOURCES = [
            "Instagram",
            "Facebook",
            "Tiktok",
            "Website",
          ...
          if (redirect_source && !ALLOWED_REDIRECT_SOURCES.includes(redirect_source)) {
            return res.status(400).json({ error: "Invalid redirect source." });
          }
